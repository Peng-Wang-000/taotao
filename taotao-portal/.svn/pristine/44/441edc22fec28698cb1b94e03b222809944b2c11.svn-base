		...
		<div id="consignee1" class="list-cont ui-switchable-body">
            <div id="consignee-ret"></div>
   			<ul class="ui-switchable-panel-main" id="consignee-list">
				<!---->
				<li class="ui-switchable-panel" id="consignee_index_137617472" style="cursor: pointer;">
					<div class="consignee-item item-selected" id="consignee_index_div_137617472">
						<b></b>
						<div class="user-name">
							<div class="fl">
								<strong >入云龙</strong>&nbsp;&nbsp;收
						...
						<div class="mt10" >北京 昌平区 五环外六环里</div>
						<div class="adr-m" >西三旗 xxxxxxxxx</div>
						<div class="op-btns ar">
							<a href="#none"
								class="ftx-05 mr10 setdefault-consignee hide" >设为默认地址</a> <a href="#none"
								class="ftx-05 mr10 edit-consignee" >编辑</a>
			...
			<ul id="payment-list">
				<li style="cursor: pointer;" onclick="save_Pay(1);">
					<div class="payment-item item-selected online-payment " >
						<b></b> 货到付款<span class="qmark-icon qmark-tip" <a href='http://help.jd.com/help/distribution-768-2-2813-2863-0-1410707152669.html' target='_blank' class='ftx-05'>查看服务及配送范围</a>></span>
				...
				<li style="cursor: pointer;" onclick="save_Pay(4);">
					...
					<div class="payment-item  online-payment " >
						<b></b> 在线支付 <font class="whiteBarSpanClass hide"
							color="#FF6600">[支持打白条]</font> 
							<span class="qmark-icon qmark-tip" <a href='http://www.jd.com/help/onlinepay.aspx' target='_blank' class='ftx-05'> 查看银行及限额</a>></span>
					</div>
				</li>
				<li style="cursor: pointer;" onclick="save_Pay(5); ">

					<div class="payment-item online-payment " >
						<b></b> 公司转账 <span class="qmark-icon qmark-tip" <a href='http://help.jd.com/help/question-70.html' target='_blank' class='ftx-05'>查看帐户信息</a>></span>
						<!--  span class="qmark-icon qmark-tip" data-tips="在线支付，支持绝大多数银行借记卡及部分银行信用卡 <a href='http://help.jd.com/help/question-68.html' target='_blank' class='ftx-05'>查看银行及限额</a>"></span -->
				...
				<li style="cursor: pointer;" onclick="save_Pay(2); ">
					...
					<div class="payment-item  online-payment " >
						<b></b> 邮局汇款 <span class="qmark-icon qmark-tip" <a href='http://help.jd.com/help/question-69.html' target='_blank' class='ftx-05'>查看帮助</a>></span>
						<!--  span class="qmark-icon qmark-tip" data-tips="在线支付，支持绝大多数银行借记卡及部分银行信用卡 <a href='http://help.jd.com/help/question-68.html' target='_blank' class='ftx-05'>查看银行及限额</a>"></span -->
		...
		<div class="goods-item goods-item-extra">
			...
			<div class="goods-msg">
				...
				<div class="p-price">
					...
					<span class="ml20 p-inventory" >有货</span>
				</div>
			...
			<ul>
				<li class="mode-tab-item " id="jd_shipment_item"
					...
					id="jdShip-span-tip" class="m-txt">淘淘快递<i
						class='qmark-icon qmark-tip' ></i></span><b></b></li>
			</ul>
		</div>
	</div>
</div>
