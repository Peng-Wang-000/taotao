            ...
            <div class="form">
                <div  id="select-regName" class="item">
                    ...
                    <div class="fl item-ifo">
                        <div class="o-intelligent-regName">
                            <input type="text" id="regName" name="username" class="text" tabindex="1"
                                   value=""
                ...
                <div id="o-password">
                    <div class="item">
                        ...
                        <div class="fl item-ifo">
                            <input type="password" id="pwd" name="password" class="text" tabindex="2" style="ime-mode:disabled;"/>
                            <i class="i-pass"></i>
                ...
                <div class="item">
                    <span class="label">&nbsp;</span>
                    <input type="button" class="btn-img btn-regist" id="registsubmit" value="立即注册" tabindex="8" onclick="REGISTER.reg();"/>
                </div>
            </div>
            <div class="phone">
